...
            // --- Construir modelos alineados a la BD (PK Cliente = cedula / FK Pago = cedula) ---
...
            var cliente = new Cliente
...

            {
                ...
                cedula = cedula,                               // FK por cédula

                metodoPago = MetodoPagoParaBD(),               // "payfac" / "simpe"

                monto = amountToPay,

                moneda = (Currency ?? "USD").ToUpperInvariant(), // varchar(3)

                estadoTilopay = status,

                datosRespuestaTilopay = payloadTexto,          // nvarchar(max)

                fechaTransaccion = DateTime.UtcNow,

                marcaTarjeta = (CardBrand ?? "").ToLowerInvariant()

                // numeroAutorizacion: opcional, depende del payload
...
                // Mantengo tu endpoint existente
